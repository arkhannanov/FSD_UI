var formNameInput = document.getElementById('form-index__name-input');
var formNameMessageContainer = document.getElementById('form-index__name-message-container');
var formNameInputerrormessage = document.getElementById('form-index__name-input-error-message');

var formEmailInput = document.getElementById('form-index__email-input');
var formEmailMessageContainer = document.getElementById('form-index__email-message-container');
var formEmailInputErrorMessage = document.getElementById('form-index__email-input-error-message');

var formMessageInput = document.getElementById('form-index__message-input');
var formSubmitButton = document.getElementById('form-index__submit-button');
var formCompleteform = document.getElementById('form-index__completeform');
