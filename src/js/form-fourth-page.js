var surnameInput = document.getElementById('form-fourth-page__surname-input');
var surnameMessage = document.getElementById('form-fourth-page__surname-message');
var surnameErrorMessage = document.getElementById('form-fourth-page__surname-error-message');

var nameInput = document.getElementById('form-fourth-page__name-input');
var nameMessage = document.getElementById('form-fourth-page__name-message');
var nameErrorMessage = document.getElementById('form-fourth-page__name-error-message');

var patronymicInput = document.getElementById('form-fourth-page__patronymic-input');
var patronymicMessage = document.getElementById('form-fourth-page__patronymic-message');
var patronymicErrorMessage = document.getElementById('form-fourth-page__patronymic-error-message');

var phoneInput = document.getElementById('form-fourth-page__phone-input');
var phoneMessage = document.getElementById('form-fourth-page__phone-message');
var phoneErrorMessage = document.getElementById('form-fourth-page__phone-error-message');

var emailInput = document.getElementById('form-fourth-page__email-input');
var emailMessage = document.getElementById('form-fourth-page__email-message');
var emailErrorMessage = document.getElementById('form-fourth-page__email-error-message');
